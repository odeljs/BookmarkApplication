...
import util.IOUtil;
//This was built to mimic the database
...
//method to load user data from file
	...
	*/
	...
	for(String row : data) {
		...
		}else if (values[5].contentEquals("t")) {
	...
	//method to load WebLinks from file
	...
	*/
	...
	//method to load movies from file
	private static void loadMovies() {
		...
		bookmarks[1][4] = BookmarkManager.getInstance().createMovie(3004,"Ikiru", "", 1952,	new String[] {"Takashi Shimura","Minoru Chiaki"}, new String[] {"Akira Kurosawa"}, MovieGenre.FOREIGN_MOVIES, 8.5);
	*/
	String[] data = new String[BOOKMARK_COUNT_PER_TYPE];
